package gr.codehub.chgroupProject.service;import gr.codehub.chgroupProject.exception.ApplicantNotFoundException;
...
class ApplicantSkillServiceImplTest {    @Mock
private ApplicantSkillRepository applicantSkillRepository;
    ...
    @InjectMocks
    private ApplicantSkillService applicantSkillService = new ApplicantSkillServiceImpl();    @Test
    void addApplicantSkillSuccessful()
        ...
        applicant.setLevel("Junior");        Skill skill=new Skill();
        skill.setId(1);
        ...
        assertEquals(1,applicantSkill.getSkill().getId());    }    @Test
