package gr.codehub.chgroupProject.service;import gr.codehub.chgroupProject.exception.JobOfferNotFoundException;
...
import org.springframework.boot.test.context.SpringBootTest;import java.util.Optional;import static org.junit.Assert.assertEquals;
import static org.mockito.Mockito.when;@SpringBootTest
class JobOfferSkillServiceImplTest {    @Mock
private JobOfferSkillRepository jobOfferSkillRepository;
    ...
    @InjectMocks
    private  JobOfferSkillService jobOfferSkillService = new JobOfferSkillServiceImpl();    @Test
    void addJobOfferSkill() throws SkillNotFoundException, JobOfferNotFoundException {
        ...
        jobOffer.setRegion("Athens");        Skill skill = new Skill();
        skill.setId(1);
        skill.setNameOfSkill("Java");        when(jobOfferRepository.findById(1)).thenReturn(Optional.of(jobOffer));
    ...
    void addJobOfferSkillJobOfferNotFound(){
        ...
        jobOffer.setCompanyName("Accenture");
        jobOffer.setLevel("Mid");        Skill skill=new Skill();
        skill.setId(1);
